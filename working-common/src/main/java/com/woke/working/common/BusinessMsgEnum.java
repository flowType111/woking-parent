...
public enum BusinessMsgEnum {
    ...
    WORKING_COMMON_OPEN_INTERFACE_ACCESS_ENABLE(40010, "账号被禁用"),

    WORKING_COMMON_TOKEN_EXPIRE(40012, "token过期"),

    WORKING_COMMON_TOKEN_INCORRECT(40013, "token不正确"),

    WORKING_COMMON_NO_API_PERMISSIONS(40014, "没有api权限"),

    WORKING_COMMON_NO_QR_CODE_IMAGE(40015, "没有匹配到支付码"),
