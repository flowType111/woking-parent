package com.woke.working.redis.util;
...
public class RedisUtil {
    ...
    public static final TimeUnit DEFAULT = TimeUnit.SECONDS;
    ...
    public void setString(String key, String value, Long seconds) {
        redisTemplate.opsForValue().set(key, value, seconds, DEFAULT);
    }
    ...
    public void setObject(String key, Serializable obj, Long seconds) {
        redisTemplate.opsForValue().set(key, obj, seconds, DEFAULT);
    }
     ...
     * @param key
     * @param value
     * @param seconds 过期时间,秒单位
     */
    public void setForTimeMS(String key, String value, long seconds) {
        redisTemplate.opsForValue().set(key, value, seconds, DEFAULT);
    }
     ...
     * @param key
     * @param value
     * @param seconds 过期时间,分钟单位
     */
    public void setForTimeMIN(String key, String value, long seconds) {
        redisTemplate.opsForValue().set(key, value, seconds, DEFAULT);
    }
     ...
     * @param key
     * @param value
     * @param minutes 过期时间,分钟单位
     */
    public void setForTimeCustom(String key, String value, long minutes, TimeUnit type) {
        redisTemplate.opsForValue().set(key, value, minutes, type);
    }
